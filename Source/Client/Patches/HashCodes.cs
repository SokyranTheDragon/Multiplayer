...
namespace Multiplayer.Client.Patches
{
    ...
    {
        private static AccessTools.FieldRef<GlowGrid, HashSet<CompGlower>> litGlowers = AccessTools.FieldRefAccess<GlowGrid, HashSet<CompGlower>>(nameof(GlowGrid.litGlowers));
