...
namespace Multiplayer.Client
{
    public static class SyncMethods
    {
        ...
        public static void Init()
        {
            ...
            SyncMethod.Lambda(typeof(Caravan), nameof(Caravan.GetGizmos), 4).SetDebugOnly();  // End shuttle cooldown
            SyncMethod.Lambda(typeof(Caravan), nameof(Caravan.GetGizmos), 5).SetDebugOnly();  // Cause mental break
            SyncMethod.Lambda(typeof(Caravan), nameof(Caravan.GetGizmos), 7).SetDebugOnly();  // Make random pawn hungry
            SyncMethod.Lambda(typeof(Caravan), nameof(Caravan.GetGizmos), 9).SetDebugOnly();  // Kill random pawn
